...
export const sendEmailReceipt = function (order) {
  ...
  mailClient.messages.create("sandbox17748ced2a0e480da1b14172416e5591.mailgun.org", {
    from: "Mailgun Sandbox <postmaster@sandbox17748ced2a0e480da1b14172416e5591.mailgun.org>",
    to: order.user.email,
  ...
  return `
    <html>
      ...
      <body>
        ...
        <p><strong>Order Date:</strong> ${order.createdAt.toISOString().replace('T', ' ').substr(0, 16)}</p>
          <h2>Order Details</h2>
          <table>
          <thead>
            <tr>
